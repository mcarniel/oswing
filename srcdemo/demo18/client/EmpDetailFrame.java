...
public class EmpDetailFrame extends InternalFrame {
  ...
  LookupController deptController = new LookupController();
  LookupServerDataLocator deptDataLocator = new LookupServerDataLocator();



  public EmpDetailFrame(FormController dataController) {
    try {
      jbInit();
      mainPanel.setFormController(dataController);

      // dept lookup...
      deptDataLocator.setGridMethodName("loadDepts");
      deptDataLocator.setValidationMethodName("validateDept");
      controlLookup.setLookupController(deptController);
      deptController.setLookupDataLocator(deptDataLocator);
      deptController.setFrameTitle("depts");
      deptController.setLookupValueObjectClassName("demo18.java.DeptVO");
      deptController.addLookup2ParentLink("deptCode", "deptCode");
      deptController.addLookup2ParentLink("description","deptDescription");
      deptController.setAllColumnVisible(false);
      deptController.setVisibleColumn("deptCode", true);
      deptController.setVisibleColumn("description", true);
      deptController.setForm(mainPanel);

      // task lookup...
      taskDataLocator.setGridMethodName("loadTasks");
      taskDataLocator.setValidationMethodName("validateTask");
      ...
      taskController.setLookupValueObjectClassName("demo18.java.TaskVO");
      taskController.addLookup2ParentLink("taskCode", "taskCode");
      taskController.addLookup2ParentLink("description","taskDescription");
  ...
  private void jbInit() throws Exception {
    ...
    mainPanel.setVOClassName("demo18.java.EmpVO");
