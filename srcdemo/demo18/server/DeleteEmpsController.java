 ...
 * <p>Description: Spring Controller used to delete emps.</p>
 * <p>Copyright: Copyright (C) 2006 Mauro Carniel</p>
 * @version 1.0
 */
public class DeleteEmpsController implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) {
    ...
    mav.addObject(
      ...
      facade.deleteEmps((ArrayList)command.getInputParam())
    );
