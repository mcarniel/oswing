 ...
 * <p>Description: Spring Controller used to delete depts.</p>
 * <p>Copyright: Copyright (C) 2006 Mauro Carniel</p>
 * @version 1.0
 */
public class DeleteDeptsController implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) {
    ...
    mav.addObject(
      ...
      facade.deleteDepts((ArrayList)command.getInputParam())
    );
