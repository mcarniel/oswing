 ...
 * <p>Description: Spring Controller used to insert depts.</p>
 * <p>Copyright: Copyright (C) 2006 Mauro Carniel</p>
 * @version 1.0
 */
public class InsertDeptsController implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) {
    ...
    mav.addObject(
      ...
      facade.insertDepts((ArrayList)command.getInputParam())
    );
