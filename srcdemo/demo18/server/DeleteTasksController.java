 ...
 * <p>Description: Spring Controller used to delete tasks.</p>
 * <p>Copyright: Copyright (C) 2006 Mauro Carniel</p>
 * @version 1.0
 */
public class DeleteTasksController implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) {
    ...
    mav.addObject(
      ...
      facade.deleteTasks((ArrayList)command.getInputParam())
    );
