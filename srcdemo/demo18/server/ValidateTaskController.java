 ...
 * <p>Description: Spring Controller used to validate a task code.</p>
 * <p>Copyright: Copyright (C) 2006 Mauro Carniel</p>
 * @version 1.0
 */
public class ValidateTaskController implements Controller {
  ...
  public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) {
    ...
    mav.addObject(
      ...
      facade.validateTask((LookupValidationParams)command.getInputParam())
    );
