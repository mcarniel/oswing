...
public class EmpDetailFrame extends InternalFrame {
  ...
  private void jbInit() throws Exception {
    ...
    setTitle("Employee");
    mainPanel.setVOClassName("demo17.EmpVO");
...
//    controlDate.setTimeFormat(Resources.H_MM_AAA);
    ...
    LookupController lookupController = new DeptLookupController(dataController.getSessions());
    controlLookup.setLookupController(lookupController);

    LookupController lookupController2 = new TaskLookupController(dataController.getSessions());
