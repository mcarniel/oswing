 ...
 * it creates an MDI Frame app with a gantt panel inside an internal frame</p>
...
public class ClientApplication implements MDIController,LoginController {
  ...
  public ClientApplication() {
    ...
    props.put("fill in the whole day","Fill in the whole day");
    props.put("remove all day appointments","Remove all day appointments");
