...
public class TreeFrameController extends TreeDataLocator implements TreeController {
  ...
  public Response getTreeModel(JTree tree) {
    ...
    DefaultMutableTreeNode n1 = new DefaultMutableTreeNode(vo1);
    TestVO vo2 = new TestVO();
    vo2.setFolderCode("C2");
    vo2.setDescription("Folder2");
    DefaultMutableTreeNode n2 = new DefaultMutableTreeNode(vo2);
    root.add(n1);
    root.add(n2);
    ...
    DefaultMutableTreeNode n11 = new DefaultMutableTreeNode(vo11);
    TestVO vo12 = new TestVO();
    vo12.setFolderCode("C12");
    vo12.setDescription("Folder12");
    vo12.setIconImageName("folder3.gif");
    DefaultMutableTreeNode n12 = new DefaultMutableTreeNode(vo12);
    n1.add(n11);
    n1.add(n12);
    ...
    DefaultMutableTreeNode n111 = new DefaultMutableTreeNode(vo111);
    TestVO vo112 = new TestVO();
    vo112.setFolderCode("C11");
    vo112.setCode("C112");
    vo112.setDescription("Node112");
    DefaultMutableTreeNode n112 = new DefaultMutableTreeNode(vo112);
    n11.add(n111);
    n11.add(n112);
    ...
    DefaultMutableTreeNode n121 = new DefaultMutableTreeNode(vo121);
    TestVO vo122 = new TestVO();
    vo122.setFolderCode("C12");
    vo122.setCode("C122");
    vo122.setDescription("Node122");
    DefaultMutableTreeNode n122 = new DefaultMutableTreeNode(vo122);
    n12.add(n121);
    n12.add(n122);
    ...
    DefaultMutableTreeNode n21 = new DefaultMutableTreeNode(vo21);
    TestVO vo22 = new TestVO();
    vo22.setFolderCode("C22");
    vo22.setDescription("Folder22");
    vo22.setIconImageName("folder3.gif");
    DefaultMutableTreeNode n22 = new DefaultMutableTreeNode(vo22);
    n2.add(n21);
    n2.add(n22);
    ...
    DefaultMutableTreeNode n211 = new DefaultMutableTreeNode(vo211);
    ...
    DefaultMutableTreeNode n212 = new DefaultMutableTreeNode(vo212);
    n21.add(n211);
    n21.add(n212);
    ...
    DefaultMutableTreeNode n221 = new DefaultMutableTreeNode(vo221);
    ...
    DefaultMutableTreeNode n222 = new DefaultMutableTreeNode(vo222);
    n22.add(n221);
    n22.add(n222);
