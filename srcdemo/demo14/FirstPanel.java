...
public class FirstPanel extends WizardInnerPanel {
  ...
  private void jbInit() throws Exception {
    ...
    radioButtonUnzip.setSelected(true);
    ...
    this.add(radioButtonZip,   new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
    this.add(radioButtonUnzip,    new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
