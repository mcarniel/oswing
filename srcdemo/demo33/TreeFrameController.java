...
public class TreeFrameController extends TreeDataLocator implements TreeController {
  ...
  public Response getTreeModel(JTree tree) {
    ...
    DefaultMutableTreeNode nb = new DefaultMutableTreeNode(vo);
    root.add(nb);
    ...
    DefaultMutableTreeNode nl = new DefaultMutableTreeNode(vo);
    root.add(nl);
