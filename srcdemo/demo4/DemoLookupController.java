      ...
      public Response validateCode(String code) {
        ...
        try {
          ...
          ResultSet rset = stmt.executeQuery(
              "select DEMO4_LOOKUP.CODE,DEMO4_LOOKUP.DESCRCODE from DEMO4_LOOKUP where CODE='" +
              code + "'");
...
//            return new ErrorResponse("Code not valid!!!!!!!!");
      ...
      public Response loadData(
        ...
        try {
          stmt = DemoLookupController.this.conn.createStatement();
          ResultSet rset = stmt.executeQuery(
              "select DEMO4_LOOKUP.CODE,DEMO4_LOOKUP.DESCRCODE from DEMO4_LOOKUP");
          ArrayList list = new ArrayList();
          while (rset.next()) {
            TestLookupVO vo = new TestLookupVO();
            vo.setLookupValue(rset.getString(1));
    ...
    this.setLookupValueObjectClassName("demo4.TestLookupVO");
