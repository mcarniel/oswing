...
public class DetailFrame extends JFrame {
  ...
  private void jbInit() throws Exception {
    ...
    mainPanel.setVOClassName("demo30.DetailTestVO");
    ...
    controlCity.setComboValueObjectClassName("demo30.TestComboVO");
    ...
    controlList.setListValueObjectClassName("demo30.TestListVO");
    ...
    controlList.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);

    controlList.addListSelectionListener(new ListSelectionListener() {

      public void valueChanged(ListSelectionEvent e) {
        if (mainPanel.getMode()!=Consts.READONLY) {
          DetailTestVO vo = (DetailTestVO)mainPanel.getVOModel().getValueObject();
          ArrayList list = vo.getPricelists();
          if (list==null) {
            list = new ArrayList();
            vo.setPricelists(list);
          }
          list.clear();
          list.addAll((java.util.List)controlList.getValue()); // add TestListVO objects related to selected items...
  ...
  public ListVOControl getControlList() {
    return controlList;
  }
