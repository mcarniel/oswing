...
public class DetailFrame extends InternalFrame {
  ...
  private LookupController lookupController = new LookupController();
  private LookupServerDataLocator dataLocator = new LookupServerDataLocator();


  public DetailFrame(FormController dataController) {
    try {
      jbInit();
  ...
  private void jbInit() throws Exception {
    mainPanel.setVOClassName("demo5.java.TestVO");
...
//    controlDate.setTimeFormat(Resources.H_MM_AAA);
    ...
    lookupController.setLookupValueObjectClassName("demo5.java.TestLookupVO");
    lookupController.addLookup2ParentLink("lookupValue", "lookupValue");
    lookupController.addLookup2ParentLink("descrLookupValue", "descrLookupValue");
    lookupController.setAllColumnVisible(true);
    lookupController.setPreferredWidthColumn("descrLookupValue", 200);
    lookupController.setLookupDataLocator(dataLocator);
    controlLookup.setLookupController(lookupController);
    dataLocator.setGridMethodName("lookupGrid");
    dataLocator.setValidationMethodName("lookupValidate");
